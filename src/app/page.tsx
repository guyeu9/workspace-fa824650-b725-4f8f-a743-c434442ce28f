    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans antialiased" suppressHydrationWarning>
      ...
      {!showWelcome && (
        <div className="flex flex-col min-h-screen w-full bg-gradient-to-br from-slate-50 via-indigo-50/20 to-purple-50/20 relative overflow-hidden" suppressHydrationWarning>
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-400/5 via-purple-400/5 to-pink-400/5 backdrop-blur-sm"></div>
          <div className="bg-white/90 backdrop-blur-xl border-b border-white/50 sticky top-0 z-10 shadow-lg shadow-indigo-500/5 relative" suppressHydrationWarning>
            <div className="px-2 sm:px-4 lg:px-6 py-1.5 sm:py-2 lg:py-3">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-2 lg:gap-3">
                  <h1 className="text-base sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent tracking-tight flex items-center gap-1 sm:gap-1.5 lg:gap-2" suppressHydrationWarning>
                    <span className="text-base sm:text-xl lg:text-2xl">🎮</span>
                    <span>文本引擎</span>
                  </h1>
                  
                  <div className="flex flex-wrap gap-1 sm:gap-1.5 lg:gap-2 items-center justify-center w-full sm:w-auto" suppressHydrationWarning>
                    <div className="relative">
                      <label className="bg-transparent text-purple-600 hover:text-purple-700 border-2 border-purple-600 hover:border-purple-700 transition-all duration-300 font-bold px-1.5 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 rounded-lg text-xs sm:text-sm lg:text-base flex items-center gap-0.5 sm:gap-1 lg:gap-2 cursor-pointer shadow-sm hover:shadow-md active:scale-95">
                    ...
                    <button
                      ...
                      className="bg-transparent text-purple-600 hover:text-purple-700 border-2 border-purple-600 hover:border-purple-700 transition-all duration-300 font-bold px-1.5 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 rounded-lg text-xs sm:text-sm lg:text-base flex items-center gap-0.5 sm:gap-1 lg:gap-2 shadow-sm hover:shadow-md active:scale-95"
                  >
                      <span className="text-xs sm:text-sm lg:text-base">📥</span>
                    ...
                    >
                      <IconFeedback className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                      <span className="hidden sm:inline">反馈</span>
                    </a>
                    
                    <a
                      href="/validator"
                      className="bg-transparent text-emerald-600 hover:text-emerald-700 border-2 border-emerald-600 hover:border-emerald-700 transition-all duration-300 font-bold px-1.5 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 rounded-lg text-xs sm:text-sm lg:text-base flex items-center gap-0.5 sm:gap-1 lg:gap-2 shadow-sm hover:shadow-md active:scale-95"
                      suppressHydrationWarning
                    >
                      <IconScroll className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                      <span className="hidden sm:inline">验证JSON</span>
                    </a>
                    ...
                    <button
                      ...
                      className="bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300 font-bold px-2 sm:px-4 lg:px-5 py-1 sm:py-1.5 lg:py-2 rounded-lg text-xs sm:text-sm lg:text-base flex items-center gap-0.5 sm:gap-1 lg:gap-2 shadow-sm hover:shadow-md active:scale-95"
                    >
                      <IconHome className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
          ...
          <div className="sticky bottom-0 z-40 bg-white/90 backdrop-blur-xl border-t border-white/50 shadow-lg shadow-indigo-500/5 relative" suppressHydrationWarning>
            <div className="p-5 sm:p-6 lg:p-8 max-w-4xl mx-auto" suppressHydrationWarning>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4" suppressHydrationWarning>
                ...
                <div className="flex gap-2 sm:gap-3 lg:gap-4" suppressHydrationWarning>
                  <button
                    onClick={exportTxt}
                    className="bg-transparent text-purple-600 hover:text-purple-700 border-2 border-purple-600 hover:border-purple-700 transition-all duration-300 font-bold px-4 sm:px-5 lg:px-6 py-3 sm:py-3.5 lg:py-4 rounded-xl shadow-sm hover:shadow-md active:scale-95 text-sm sm:text-base lg:text-lg flex items-center justify-center gap-2 sm:gap-3 min-w-[100px] sm:min-w-[110px] lg:min-w-[130px]"
                  >
                    <IconFile className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
                  ...
                  <button
                    ...
                    className="bg-transparent text-purple-600 hover:text-purple-700 border-2 border-purple-600 hover:border-purple-700 transition-all duration-300 font-bold px-4 sm:px-5 lg:px-6 py-3 sm:py-3.5 lg:py-4 rounded-xl shadow-sm hover:shadow-md active:scale-95 text-sm sm:text-base lg:text-lg flex items-center justify-center gap-2 sm:gap-3 min-w-[100px] sm:min-w-[110px] lg:min-w-[130px]"
                  >
                    <IconSave className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7" />
